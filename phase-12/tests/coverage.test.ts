...
describe("coverage — input kinds and verification paths", () => {
  ...
  it("FAILED when a provider returns an approval without approver (verification gate)", async () => {
    const broken: ScientificDecisionProvider = {
